...
export default function ErrorLevel() {
    ...
    return (
        <div className="error-level-system">
            {AddPopupLayout}
            {DeletePopupLayout}
            <div className="page-breadcrumb">
                <div className="row">
                    <div className="col-md-6"><h2>{t('error_level.title')}</h2>
                    </div>
            ...
            <div className="data-view">
                <div className="main-header">
                    <div className="header-row">
                        ...
                        <div className={searchParam.sort_column === "name" ? "header-col width30 sorting " + searchParam.order_by : "header-col width30 sorting"}><p>{t('error_level.name')}</p></div>
                        <div className="header-col width30"><p>{t('error_level.description')}</p></div>
