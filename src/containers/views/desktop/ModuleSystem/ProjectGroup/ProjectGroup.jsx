    ...
    return (
        <div className="position">
            ...
            <div className="page-breadcrumb">
                <div className="row">
                    <div className="col-md-6"><h2>{t('project_group.title')}</h2>
                    </div>
            ...
            {this.state.formSearch ?
                <div className="form-search">
                    <div className="row">
                        ...
                        <div className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            <div className="mb-3">
                                <RText label={t('project_group.name')}
                                    inputClass="form-control"
                                    inputId="name"
                                    inputName="name"
            ...
            <div className="data-view">
                <div className="main-header">
                    <div className="header-row">
                        ...
                        <div onClick={e => this.onSort(e, 'name')} className={searchParam.sort_column === "name" ? "header-col width40 sorting " + searchParam.order_by : "header-col width40 sorting"}><p>{t('project_group.name')}</p></div>
                        <div className="header-col width30"><p>{t('project_group.description')}</p></div>
