                    ...
                    <div className="info">
                        <div className="row">
                            ...
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div className="mb-3">
                                    <RTextArea label={t('project_group.description')}
                                        inputClass="form-control"
        ...
        <Modal visible={true} className="modal-add" dialogClassName="modal-lg modal-dialog-scrollable" >
            <div className="modal-header">
                <h5 className="modal-title">
                    {(curItem.screen_mode === Constants.SCREEN_MODE.EDIT) ? t('project_group.edit_title') : t('project_group.add_title')}
                </h5>
                    ...
                    <div className="box-info-content">
                        <div className="row">
                            <div className="col-xl-3 col-lg-3 col-md-3 col-12">
                                <div className="mb-3">
                                    <p className="control-label">{t('project_group.status')}</p>
