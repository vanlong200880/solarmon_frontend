import ErrorJsx from './Error.jsx';
...
class Error extends BaseComponent {
    ...
    getList() {
        ...
        ErrorService.instance.getList(params, (data, total_row) => {
    ...
    onItemClick = (index) => {
        ...
        ErrorService.instance.getDetail(params, data => {
            if (data) {
                item.data = data.data;
    ...
    onStatusChange = (index) => {
        ...
        ErrorService.instance.updateStatus(item, function (status, msg) {
            if (status) {
                self.setState({
...
const HighOrderComponentTranslated = withTranslation('common')(Error)
