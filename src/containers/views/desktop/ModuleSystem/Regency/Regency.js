import RegencyJsx from './Regency.jsx';
...
class Regency extends BaseComponent {

    constructor(props, context) {
        super(props, context);
        this.jsxTemplate = RegencyJsx;
        this.state = {
            curItem: {},
            dataList: [],
            searchParam: {
    ...
    getList() {
        ...
        RegencyService.instance.getList(params, (data, total_row) => {
    ...
    onItemClick = (index) => {
        ...
        RegencyService.instance.getDetail(params, data => {
            if (data) {
                item.data = data.data;
    ...
    onStatusChange = (index) => {
        ...
        RegencyService.instance.updateStatus(item, function (status, msg) {
            if (status) {
                self.setState({
...
const HighOrderComponentTranslated = withTranslation('common')(Regency)
