import ErrorStateJsx from './ErrorState.jsx';
...
class ErrorState extends BaseComponent {

    constructor(props, context) {
        super(props, context);
        this.jsxTemplate = ErrorStateJsx;
        this.state = {
            curItem: {},
            dataList: [],
            searchParam: {
    ...
    getList() {
        ...
        ErrorStateService.instance.getList(params, (data, total_row) => {
    ...
    onItemClick = (index) => {
        ...
        ErrorStateService.instance.getDetail(params, data => {
            if (data) {
                item.data = data.data;
    ...
    onStatusChange = (index) => {
        ...
        ErrorStateService.instance.updateStatus(item, function (status, msg) {
            if (status) {
                self.setState({
...
const HighOrderComponentTranslated = withTranslation('common')(ErrorState)
