    ...
    return (
        <div className="error-type-system">
            ...
            <div className="page-breadcrumb">
                <div className="row">
                    <div className="col-md-6"><h2>{t('device_parameter.title')}</h2>
                    </div>
            ...
            <div className="data-view">
                <div className="main-header">
                    <div className="header-row">
                        ...
                        <div className="header-col width20"><p>{t('device_parameter.id_device_group')}</p></div>
                        <div className="header-col width20"><p>{t('device_parameter.name')}</p></div>
                        <div className="header-col width20"><p>{t('device_parameter.slug')}</p></div>
                        <div className="header-col width10"><p>{t('device_parameter.unit')}</p></div>
